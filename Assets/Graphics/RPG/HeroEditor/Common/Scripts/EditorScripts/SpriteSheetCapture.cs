...
namespace Assets.HeroEditor.Common.Scripts.EditorScripts
{
    ...
    public class SpriteSheetCapture : MonoBehaviour
    {
        ...
        {
            _character = UnityEngine.Object.FindFirstObjectByType<Character>();
            ...
            yield return Common.StandaloneFilePicker.SaveFile("Save as sprite sheet", "", "Character", ".png", texture.EncodeToPNG(), (success, path) => { Debug.Log(success ? $"Saved as {path}" : "Error saving."); });
        }
